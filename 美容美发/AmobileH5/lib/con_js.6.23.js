...
$.fn.extend({
	Swiper:function(json){
		...
		if(swiperDefaultParam.fenyeStyle)
		{
		...
		var swiper_objs={};
         ...
         doms.each(function(){
		    ...
		    swiper_objs[_swiperSerial]=new Swiper(".SwiperSerial_"+_swiperSerial, $.extend({},swiperDefaultParam,{"pagination":".fenye_"+_swiperSerial}));
