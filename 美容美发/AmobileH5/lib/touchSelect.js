...
//	            	   			})();
            ...
            if(_self.params.getereaId||typeof _self.params.callback=="function"){
                ...
                $(_self.trigger).data("ereaId",provinceCode +((cityCode)?(',' + cityCode):('')) + ((countyCode)?(',' + countyCode):('')))
                  var erea_json={ereaId:$(_self.trigger).data("ereaId"),ereaName:_self.trigger.value||_self.trigger.innerText};
                typeof _self.params.callback=="function"&&_self.params.callback(erea_json);
            }
